...
point_cloud= np.fromfile("C:/Users/Pnagaraj/Lidar/dataset/training/velodyne/000020.bin",dtype=np.float32).reshape(-1,4)
point_cloud = point_cloud[point_cloud[:, 0] > -2.5, :]
calib_path = "C:/Users/Pnagaraj/Lidar/visualization/calib/000021.txt"
...
write_pinhole_camera_trajectory("C:/Users/Pnagaraj/Lidar/dataset/training/000021.json",camera_trajectory)
vis.destroy_window()
