...
import cv2
import pickle
from parameter import color_dictionary
sys.path.append("C:/Users/Pnagaraj/Lidar/visualization")
sys.path.append("C:/Users/Pnagaraj/Lidar/dataset/training/velodyne/")

#pickle_path= "C:/Users/Pnagaraj/Lidar/dataset/detection_results_v1.pickle"
...
def create3dBbox_images(center, h, w, l, calib_matrix,r_y,type_list,color_dicts):
    ...
    Bbox_image['colors'] = color_dicts[type_list]
...
def  create3dBbox_on_lidar_images(center,h,w,l,r_y,type_list,color_dicts):
    color = [1, 0.75, 0]  # Normalized RGB
    front_color = [1, 0, 0]  # Normalized RGB
...
def create_gt_2d_bbox(xmin,ymin,xmax,ymax,type_list,color_dicts):
    ...
    gt_2d_bbox_on_image["colors"]= color_dicts[type_list]
